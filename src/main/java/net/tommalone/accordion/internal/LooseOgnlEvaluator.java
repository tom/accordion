...
public class LooseOgnlEvaluator implements Evaluator {
    private final Object rootObject;
    private final OgnlContext ognlContext;

    public LooseOgnlEvaluator(Evaluator evaluator) {
        this.rootObject = ReflectiveHelper.getValue(evaluator, "rootObject");
        this.ognlContext = (OgnlContext) ReflectiveHelper.getValue(evaluator, "ognlContext");
    }
